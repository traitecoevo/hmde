...
stanmodels <- c("affine_single_ind", "canham_multi_ind", "canham_single_ind", "constant_multi_ind", "constant_single_ind", "vb_multi_ind", "vb_single_ind", "zeide_multi_ind", "zeide_single_ind")
...
Rcpp::loadModule("stan_fit4zeide_multi_ind_mod", what = TRUE)
Rcpp::loadModule("stan_fit4zeide_single_ind_mod", what = TRUE)
