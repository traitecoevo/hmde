...
#' Data configuration template for Canham growth multiple individuals model
#' @keywords internal
#' @noRd
...
#' Data configuration template for von Bertalanffy growth multiple individuals model
#' @keywords internal
#' @noRd
