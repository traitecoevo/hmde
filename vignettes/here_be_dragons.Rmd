...
plot_data <- tibble(
  x = c(0, (beta_0/beta_1), 0, 0, 0, error_ests$Y_max),
  y = c(beta_0, 0, error_ests$error_beta_0, 0,0,0),
...
The following block uses the `plot_grid` function to produce arranged figures.
```{r, eval=FALSE}
#Histograms
plot_grid(beta_0_plot_list[[1]], 
          beta_0_plot_list[[2]],
