...
Our final case study reproduces analysis from [Paper 1] and [Paper 2] with a small sample size for G. recondita in order to make the model tractable for a demonstration.
