...
Due to the complexity of the Canham model the sampling can take a while. We typically see a few hours for the following to run.
```{r}
...
```{r}
#tree_canham_fit <-readRDS(file="data-raw/TreeSizeFit.rds")
#tree_canham_estimates <- readRDS(file="data-raw/TreeSizeEsts.rds")
