...
namespace model_power_single_ind_namespace {
...
static constexpr std::array<const char*, 80> locations_array__ =
  ...
  " (in 'string', line 88, column 2 to column 22)",
  " (in 'string', line 89, column 2 to column 22)",
  " (in 'string', line 90, column 2 to column 18)",
  " (in 'string', line 93, column 6 to column 25)",
  " (in 'string', line 92, column 23 to line 94, column 5)",
  " (in 'string', line 92, column 4 to line 94, column 5)",
  " (in 'string', line 100, column 6 to column 62)",
  " (in 'string', line 99, column 11 to line 101, column 5)",
  " (in 'string', line 97, column 6 to column 73)",
  " (in 'string', line 98, column 6 to column 43)",
  " (in 'string', line 95, column 17 to line 99, column 5)",
  " (in 'string', line 95, column 4 to line 101, column 5)",
  " (in 'string', line 91, column 19 to line 102, column 3)",
  " (in 'string', line 91, column 2 to line 102, column 3)",
  " (in 'string', line 60, column 13 to column 18)",
  " (in 'string', line 60, column 2 to column 20)",
  " (in 'string', line 61, column 2 to column 17)",
  " (in 'string', line 62, column 2 to column 22)",
  " (in 'string', line 63, column 2 to column 22)",
  " (in 'string', line 64, column 2 to column 18)",
  " (in 'string', line 67, column 6 to column 25)",
  " (in 'string', line 66, column 23 to line 68, column 5)",
  " (in 'string', line 66, column 4 to line 68, column 5)",
  " (in 'string', line 71, column 6 to column 73)",
  " (in 'string', line 69, column 17 to line 72, column 5)",
  " (in 'string', line 69, column 4 to line 72, column 5)",
  " (in 'string', line 65, column 19 to line 73, column 3)",
  " (in 'string', line 65, column 2 to line 73, column 3)",
  " (in 'string', line 75, column 2 to column 44)",
  " (in 'string', line 78, column 2 to column 48)",
  ...
  " (in 'string', line 43, column 13 to column 18)",
  " (in 'string', line 43, column 2 to column 20)",
  " (in 'string', line 44, column 16 to column 21)",
  " (in 'string', line 44, column 2 to column 23)",
  " (in 'string', line 45, column 12 to column 17)",
  " (in 'string', line 45, column 2 to column 19)",
  " (in 'string', line 46, column 2 to column 13)",
  " (in 'string', line 47, column 2 to column 15)",
  " (in 'string', line 85, column 13 to column 18)",
  " (in 'string', line 86, column 17 to column 22)",
...
class model_power_single_ind final : public model_base_crtp<model_power_single_ind> {
private:
  double step_size;
  int n_obs;
  ...
  double y_0_obs;
public:
  ~model_power_single_ind() {}
  model_power_single_ind(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_power_single_ind_namespace::model_power_single_ind";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_power_single_ind_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      ind_y_0 = in__.template read_constrain_lb<local_scalar_t__,
                  jacobian__>(0, lp__);
      local_scalar_t__ ind_coeff = DUMMY_VAR__;
      current_statement__ = 2;
      ind_coeff = in__.template read_constrain_lb<local_scalar_t__,
                    jacobian__>(0, lp__);
      local_scalar_t__ ind_power = DUMMY_VAR__;
      current_statement__ = 3;
      ind_power = in__.template read_constrain_lb<local_scalar_t__,
                    jacobian__>(0, lp__);
                             ...
                             jacobian__>(0, lp__);
      {
        ...
        stan::model::assign(pars, ind_coeff, "assigning variable pars",
          stan::model::index_uni(1));
        current_statement__ = 26;
        stan::model::assign(pars, ind_power, "assigning variable pars",
        ...
        lp_accum__.add(stan::math::lognormal_lpdf<propto__>(ind_coeff, 0, 1));
        current_statement__ = 39;
        lp_accum__.add(stan::math::lognormal_lpdf<propto__>(ind_power, 0, 1));
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_power_single_ind_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      ind_y_0 = in__.template read_constrain_lb<local_scalar_t__,
                  jacobian__>(0, lp__);
      double ind_coeff = std::numeric_limits<double>::quiet_NaN();
      current_statement__ = 2;
      ind_coeff = in__.template read_constrain_lb<local_scalar_t__,
                    jacobian__>(0, lp__);
      double ind_power = std::numeric_limits<double>::quiet_NaN();
      current_statement__ = 3;
      ind_power = in__.template read_constrain_lb<local_scalar_t__,
                    jacobian__>(0, lp__);
  ...
  unconstrain_array_impl(const VecVar& params_r__, const VecI& params_i__,
    ...
    try {
      ...
      local_scalar_t__ ind_coeff = DUMMY_VAR__;
      current_statement__ = 2;
      ind_coeff = in__.read<local_scalar_t__>();
      out__.write_free_lb(0, ind_coeff);
      local_scalar_t__ ind_power = DUMMY_VAR__;
      current_statement__ = 3;
      ind_power = in__.read<local_scalar_t__>();
  ...
  transform_inits_impl(const stan::io::var_context& context__, VecVar&
    ...
    try {
      ...
      local_scalar_t__ ind_coeff = DUMMY_VAR__;
      current_statement__ = 2;
      ind_coeff = context__.vals_r("ind_coeff")[(1 - 1)];
      out__.write_free_lb(0, ind_coeff);
      local_scalar_t__ ind_power = DUMMY_VAR__;
      current_statement__ = 3;
      ind_power = context__.vals_r("ind_power")[(1 - 1)];
      out__.write_free_lb(0, ind_power);
      local_scalar_t__ global_error_sigma = DUMMY_VAR__;
      current_statement__ = 4;
...
using stan_model = model_power_single_ind_namespace::model_power_single_ind;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_power_single_ind_namespace::profiles__;
}
#endif
#endif
