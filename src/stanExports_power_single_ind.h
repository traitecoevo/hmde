...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in 'power_single_ind', line 52, column 2 to column 24)",
                                                      ...
                                                      " (in 'power_single_ind', line 43, column 2 to column 20)",
                                                      " (in 'power_single_ind', line 44, column 16 to column 21)",
                                                      " (in 'power_single_ind', line 44, column 2 to column 23)",
                                                      " (in 'power_single_ind', line 45, column 12 to column 17)",
                                                      ...
                                                      " (in 'power_single_ind', line 25, column 4 to column 24)",
...
public:
  ...
  inline std::string model_name() const final { return "model_power_single_ind"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_power_single_ind(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_power_single_ind_namespace::model_power_single_ind";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_power_single_ind_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      local_scalar_t__ ind_coeff;
      ind_coeff = DUMMY_VAR__;
      
      current_statement__ = 2;
      ind_coeff = in__.scalar();
      current_statement__ = 2;
      if (jacobian__) {
        current_statement__ = 2;
        ind_coeff = stan::math::lb_constrain(ind_coeff, 0, lp__);
      } else {
        current_statement__ = 2;
        ind_coeff = stan::math::lb_constrain(ind_coeff, 0);
      }
      local_scalar_t__ ind_power;
      ind_power = DUMMY_VAR__;
      
      current_statement__ = 3;
      ind_power = in__.scalar();
      current_statement__ = 3;
      if (jacobian__) {
        current_statement__ = 3;
        ind_power = stan::math::lb_constrain(ind_power, 0, lp__);
      } else {
        current_statement__ = 3;
        ind_power = stan::math::lb_constrain(ind_power, 0);
      }
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_power_single_ind_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
    ...
    try {
      ...
      ind_y_0 = stan::math::lb_constrain(ind_y_0, 0);
      double ind_coeff;
      ind_coeff = std::numeric_limits<double>::quiet_NaN();
      ...
      ind_coeff = stan::math::lb_constrain(ind_coeff, 0);
      double ind_power;
      ind_power = std::numeric_limits<double>::quiet_NaN();
      ...
      vars__.emplace_back(ind_coeff);
      vars__.emplace_back(ind_power);
  ...
  inline void transform_inits_impl(const stan::io::var_context& context__,
    ...
    try {
      ...
      double ind_coeff_free__;
      ind_coeff_free__ = std::numeric_limits<double>::quiet_NaN();
      
      current_statement__ = 2;
      ind_coeff_free__ = stan::math::lb_free(ind_coeff, 0);
      double ind_power;
      ind_power = std::numeric_limits<double>::quiet_NaN();
      
      current_statement__ = 3;
      ind_power = context__.vals_r("ind_power")[(1 - 1)];
      double ind_power_free__;
      ind_power_free__ = std::numeric_limits<double>::quiet_NaN();
      
      current_statement__ = 3;
      ind_power_free__ = stan::math::lb_free(ind_power, 0);
      double global_error_sigma;
      global_error_sigma = std::numeric_limits<double>::quiet_NaN();
      ...
      vars__.emplace_back(ind_coeff_free__);
      vars__.emplace_back(ind_power_free__);
