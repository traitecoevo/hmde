...
public:
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    try {
      ...
      ind_y_0 = in__.template read_constrain_lb<local_scalar_t__,
                  jacobian__>(0, lp__);
      local_scalar_t__ ind_growth_par = DUMMY_VAR__;
      current_statement__ = 2;
      ind_growth_par = in__.template read_constrain_lb<local_scalar_t__,
                         jacobian__>(0, lp__);
                             ...
                             jacobian__>(0, lp__);
      {
        ...
        stan::model::assign(pars, ind_growth_par, "assigning variable pars",
          stan::model::index_uni(1));
        current_statement__ = 25;
        stan::model::assign(pars, ind_max_size, "assigning variable pars",
        ...
        lp_accum__.add(stan::math::lognormal_lpdf<propto__>(ind_max_size,
                         stan::math::max(stan::math::log(y_obs)), 1));
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    try {
      ...
      ind_y_0 = in__.template read_constrain_lb<local_scalar_t__,
                  jacobian__>(0, lp__);
      double ind_growth_par = std::numeric_limits<double>::quiet_NaN();
      current_statement__ = 2;
      ind_growth_par = in__.template read_constrain_lb<local_scalar_t__,
                         jacobian__>(0, lp__);
  ...
  unconstrain_array_impl(const VecVar& params_r__, const VecI& params_i__,
    ...
    try {
      ...
      local_scalar_t__ ind_growth_par = DUMMY_VAR__;
      current_statement__ = 2;
      ind_growth_par = in__.read<local_scalar_t__>();
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"ind_y_0", "ind_growth_par",
                "ind_max_size", "global_error_sigma"};
