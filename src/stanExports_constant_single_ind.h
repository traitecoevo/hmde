...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in 'constant_single_ind', line 22, column 2 to column 24)",
                                                      " (in 'constant_single_ind', line 23, column 2 to column 25)",
                                                      " (in 'constant_single_ind', line 25, column 2 to column 35)",
                                                      " (in 'constant_single_ind', line 51, column 2 to column 20)",
                                                      " (in 'constant_single_ind', line 52, column 2 to column 24)",
                                                      " (in 'constant_single_ind', line 56, column 6 to column 25)",
                                                      " (in 'constant_single_ind', line 55, column 23 to line 57, column 5)",
                                                      " (in 'constant_single_ind', line 55, column 4 to line 57, column 5)",
                                                      " (in 'constant_single_ind', line 63, column 6 to column 56)",
                                                      " (in 'constant_single_ind', line 62, column 11 to line 64, column 5)",
                                                      " (in 'constant_single_ind', line 60, column 6 to column 70)",
                                                      " (in 'constant_single_ind', line 61, column 6 to column 43)",
                                                      " (in 'constant_single_ind', line 59, column 17 to line 62, column 5)",
                                                      " (in 'constant_single_ind', line 59, column 4 to line 64, column 5)",
                                                      " (in 'constant_single_ind', line 53, column 19 to line 65, column 3)",
                                                      " (in 'constant_single_ind', line 53, column 2 to line 65, column 3)",
                                                      " (in 'constant_single_ind', line 29, column 13 to column 18)",
                                                      " (in 'constant_single_ind', line 29, column 2 to column 20)",
                                                      " (in 'constant_single_ind', line 33, column 6 to column 25)",
                                                      " (in 'constant_single_ind', line 32, column 23 to line 34, column 5)",
                                                      " (in 'constant_single_ind', line 32, column 4 to line 34, column 5)",
                                                      " (in 'constant_single_ind', line 37, column 6 to column 70)",
                                                      " (in 'constant_single_ind', line 36, column 17 to line 38, column 5)",
                                                      " (in 'constant_single_ind', line 36, column 4 to line 38, column 5)",
                                                      " (in 'constant_single_ind', line 30, column 19 to line 39, column 3)",
                                                      " (in 'constant_single_ind', line 30, column 2 to line 39, column 3)",
                                                      " (in 'constant_single_ind', line 41, column 2 to column 44)",
                                                      " (in 'constant_single_ind', line 44, column 2 to column 48)",
                                                      " (in 'constant_single_ind', line 45, column 2 to column 31)",
                                                      " (in 'constant_single_ind', line 47, column 2 to column 37)",
                                                      ...
                                                      " (in 'constant_single_ind', line 17, column 2 to column 15)",
                                                      " (in 'constant_single_ind', line 51, column 13 to column 18)",
                                                      " (in 'constant_single_ind', line 52, column 17 to column 22)",
...
public:
  ...
  inline std::string model_name() const final { return "model_constant_single_ind"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_constant_single_ind(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_constant_single_ind_namespace::model_constant_single_ind";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_constant_single_ind_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      local_scalar_t__ ind_beta;
      ind_beta = DUMMY_VAR__;
      
      current_statement__ = 2;
      ind_beta = in__.scalar();
      current_statement__ = 2;
      if (jacobian__) {
        current_statement__ = 2;
        ind_beta = stan::math::lb_constrain(ind_beta, 0, lp__);
      } else {
        current_statement__ = 2;
        ind_beta = stan::math::lb_constrain(ind_beta, 0);
      }
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_constant_single_ind_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
    ...
    try {
      ...
      ind_y_0 = stan::math::lb_constrain(ind_y_0, 0);
      double ind_beta;
      ind_beta = std::numeric_limits<double>::quiet_NaN();
      ...
      for (int i = 1; i <= n_obs; ++i) {
        ...
        if (logical_lt(i, n_obs)) {
          ...
          assign(Delta_hat, cons_list(index_uni(i), nil_index_list()),
            (DE(ind_beta, pstream__) * (time[(i - 1)] - time[((i - 1) - 1)])),
            "assigning variable Delta_hat");
        }}
  ...
  inline void transform_inits_impl(const stan::io::var_context& context__,
    ...
    try {
      ...
      double ind_beta_free__;
      ind_beta_free__ = std::numeric_limits<double>::quiet_NaN();
      
      current_statement__ = 2;
      ind_beta_free__ = stan::math::lb_free(ind_beta, 0);
      double global_error_sigma;
      global_error_sigma = std::numeric_limits<double>::quiet_NaN();
      ...
      vars__.emplace_back(ind_beta_free__);
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"ind_y_0\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"ind_beta\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"global_error_sigma\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"y_hat\",\"type\":{\"name\":\"array\",\"length\":" << n_obs << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"generated_quantities\"},{\"name\":\"Delta_hat\",\"type\":{\"name\":\"array\",\"length\":" << n_obs << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"generated_quantities\"}]";
    return s__.str();
