...
#include "stanExports_vb_single_ind.h"

RCPP_MODULE(stan_fit4vb_single_ind_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_vb_single_ind")
