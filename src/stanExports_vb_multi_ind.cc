...
#include "stanExports_vb_multi_ind.h"

RCPP_MODULE(stan_fit4vb_multi_ind_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_vb_multi_ind")
